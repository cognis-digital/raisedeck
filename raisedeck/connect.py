"""Native cognis-connect emit for raisedeck — forward findings to any platform.

Maps raisedeck's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    raisedeck ... --format json | raisedeck-emit --to stix
    raisedeck-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
