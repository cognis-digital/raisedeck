#!/usr/bin/env sh
# Universal installer for raisedeck. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/raisedeck.git"
echo "Installing raisedeck ..."
